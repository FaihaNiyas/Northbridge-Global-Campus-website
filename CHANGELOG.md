...
| File | Change |
|---|---|
| `careers.html` | Unconfirmed payment wording removed pending management confirmation of payment terms (F14): "Paid per engagement." dropped from the Teach a programme card, and "paid" from the "What you get from it" sentence. Nothing else changed. |
